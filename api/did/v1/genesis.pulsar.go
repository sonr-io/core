...
var (
	...
	fd_PublicKey_key_value protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_PublicKey_key_value = md_PublicKey.Fields().ByName("key_value")
}
...
func (x *fastReflection_PublicKey) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.KeyValue) != 0 {
		value := protoreflect.ValueOfBytes(x.KeyValue)
		if !f(fd_PublicKey_key_value, value) {
			return
		}
	}
}
...
func (x *fastReflection_PublicKey) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "did.v1.PublicKey.key_type":
		return x.KeyType != ""
	case "did.v1.PublicKey.key_value":
		return len(x.KeyValue) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_PublicKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "did.v1.PublicKey.key_value":
		panic(fmt.Errorf("field key_value of message did.v1.PublicKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: did.v1.PublicKey"))
		}
...
func (x *fastReflection_PublicKey) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.KeyValue) > 0 {
			i -= len(x.KeyValue)
			copy(dAtA[i:], x.KeyValue)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.KeyValue)))
			i--
			dAtA[i] = 0x12
		}
		if len(x.KeyType) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field KeyValue", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.KeyValue = append(x.KeyValue[:0], dAtA[iNdEx:postIndex]...)
				if x.KeyValue == nil {
					x.KeyValue = []byte{}
				}
				iNdEx = postIndex
...
func init() {
	file_did_v1_genesis_proto_init()
	md_VerificationMethod = File_did_v1_genesis_proto.Messages().ByName("VerificationMethod")
...
var file_did_v1_genesis_proto_rawDesc = []byte{
	...
	0x22, 0x43, 0x0a, 0x09, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x19, 0x0a,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x9e, 0x01, 0x0a, 0x12, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69,
	...
	0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x42, 0x61, 0x73, 0x65, 0x36, 0x34, 0x12, 0x18, 0x0a, 0x07,
	0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73,
	0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x7d, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x69,
	...
	0x2f, 0x73, 0x6f, 0x6e, 0x72, 0x2d, 0x69, 0x6f, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x61, 0x70,
...
var file_did_v1_genesis_proto_goTypes = []interface{}{
	...
	(*PublicKey)(nil),          // 6: did.v1.PublicKey
	(*VerificationMethod)(nil), // 7: did.v1.VerificationMethod
}
